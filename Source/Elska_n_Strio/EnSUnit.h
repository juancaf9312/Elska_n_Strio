...
#include "EnSUnit.generated.h"

class UInputComponent;

UCLASS(config=Game)
class AEnSUnit : public ACharacter, public IAbilitySystemInterface, public IGenericTeamAgentInterface
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = Abilities)
	class UEnSUnitAttributeSet* AttributeSet;
