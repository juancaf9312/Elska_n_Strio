...
AEnSPlayerSpawnPoint::AEnSPlayerSpawnPoint(const FObjectInitializer& ObjectInitializer)
...
UArrowComponent* AEnSPlayerSpawnPoint::GetArrowComponent() const { return ArrowComponent; }
#endif
